...
import com.example.spotifygroups.datamodel.SearchUsersResultModel
...
class FriendRepository(private val userId: String, private val token: String) {
    ...
    fun searchUsers(query: String): SearchUsersResultModel {
        val resultModel = SearchUsersResultModel(0)
        try {
